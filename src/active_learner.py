...
class ActiveLearner():
    ...
    def _fit_to_known(self, **fit_kwargs):
        ...
        checkpointer = ModelCheckpoint(filepath=os.path.join(self.weights_path,'_best_weights.{epoch:02d}.h5'), verbose=1, monitor='val_loss', mode='auto', save_best_only=True)
